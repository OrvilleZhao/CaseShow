package com.orville.caseshow.service.nlpir;

import com.orville.caseshow.util.OSInfo;
import com.sun.jna.Library;
import com.sun.jna.Native;

/**
 * @program:CaseShow
 * @description:分词组件的java接口,采用JNA技术来实现
 * @author:orville
...
public interface NlpirLib extends Library {
     ...
     * 组件初始化
     * @param sDataPath
     *              Data文件夹的父目录，如果为空字符串(即:"")，那么程序会从项目的根目录中寻找
     * @param encoding
